...
from studyforge.source_map import map_selection
...
class StructureMappingTests(unittest.TestCase):
    def setUp(self):
        ...
        db.add_chunks(self.did,[{'page':1,'chunk_index':0,'text':'Il limite descrive il comportamento locale.'}],[[1.0,0.0]])
    def tearDown(self):
        db.settings=self.old
        try: os.unlink(self.path)
        except OSError: pass
    def test_structure_detects_headings(self):
    ...
    def test_selection_maps_to_chunk_and_bbox(self):
