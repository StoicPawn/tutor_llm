...
with left:
    ...
    if chosen:
        try:
            mapped=st.session_state.get('study_mapped_selection') or selection_context(workspace_id,document_id,int(page),selection_text,st.session_state.get('study_bbox'))
